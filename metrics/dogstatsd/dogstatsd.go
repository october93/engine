...
func NewCounter(name string, sampleRate float64, c *statsd.Client, l log.Logger) metrics.Counter {
...
func NewGauge(name string, sampleRate float64, c *statsd.Client, l log.Logger) metrics.Gauge {
...
func NewTimeHistogram(name string, sampleRate float64, c *statsd.Client, l log.Logger) metrics.TimeHistogram {
