...
func NewParser(filename string) (*Parser, error) {
	...
	clientTemplate, err := ioutil.ReadFile("../cmd/rpcgen/client.go.tmpl")
	if err != nil {
		return nil, err
	}
	serverTemplate, err := ioutil.ReadFile("../cmd/rpcgen/server.go.tmpl")
	if err != nil {
		return nil, err
	}
	loggingTemplate, err := ioutil.ReadFile("../cmd/rpcgen/logging.go.tmpl")
	if err != nil {
		return nil, err
	}
	instrumentationTemplate, err := ioutil.ReadFile("../cmd/rpcgen/instrumentation.go.tmpl")
	if err != nil {
		return nil, err
	}
	recorderTemplate, err := ioutil.ReadFile("../cmd/rpcgen/recorder.go.tmpl")
	if err != nil {
		return nil, err
	}
