...
type UserLoader struct {
	...
	cache map[globalid.ID]*model.User
...
func (l *UserLoader) unsafeSet(key globalid.ID, value *model.User) {
	if l.cache == nil {
		l.cache = map[globalid.ID]*model.User{}
	}
	l.cache[key] = value
}
...
func (b *userBatch) keyIndex(l *UserLoader, key globalid.ID) int {
